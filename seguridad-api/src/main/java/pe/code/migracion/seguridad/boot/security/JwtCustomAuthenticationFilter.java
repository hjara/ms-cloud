...
public class JwtCustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public JwtCustomAuthenticationFilter(AuthenticationManager authenticationManager) {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
		...
		String refresh_token = JWT.create().withSubject(user.getUsername())
				.withExpiresAt(new Date(System.currentTimeMillis() + JwtConstant.JWT_TOKEN_TIME_REFRESH_TOKEN))
